...
#imagem = encode_image("4241-Python-e-Gemini-Orquestrando-LLMs-com-LangChain\dados\exemplo_grafico.jpg")
imagem = encode_image("4241-Python-e-Gemini-Orquestrando-LLMs-com-LangChain\dados\eard.jpg")
...
template_analisador = ChatPromptTemplate.from_messages(
  [
    (
      ...
      de forma objetiva. Traga informações relevantes como detalhes, números, dados, comparações.

      # FORMATO DE SAÍDA
      Descrição da Imagem: 'Coloque a sua descrição da imagem aqui'
      Rótulos: 'Coloque uma lista com os termos chave separados por vírgula'
      """
    ),
    (
      "user",
...
resposta_analise = cadeia_analise_imagem.invoke({"imagem_informada": imagem})
